...
final class BoxerTest extends TestCase
{
    ...
    {
        $boxer = Boxer::new($this->strItem('test'));
    ...
    {
        $boxer = Boxer::new($this->strItem('x'));
    ...
    {
        $boxer = Boxer::new($this->strItem('still raw'));
    ...
    {
        $original = Boxer::new($this->strItem('test'));
    ...
    public function testGetInnerSizeReturnsZeroOnTinyBox(): void
    {
        ...
        $boxer = Boxer::new($this->strItem('tiny'))
            ->withPadding(1);
    ...
    {
        $noPad = Boxer::new($this->strItem('x'))->withPadding(0)->setSize(10, 3);
        $pad = Boxer::new($this->strItem('x'))->withPadding(2)->setSize(14, 7);
    ...
    {
        $boxer = Boxer::new($this->strItem('test'))->setSize(10, 5);
        [$w, $h] = $boxer->getInnerSize();
    ...
    {
        $boxer = Boxer::new($this->strItem('this is very long content'))
            ->withPadding(1)
            ->setSize(10, 5);
    ...
    {
        $noPad = Boxer::new($this->strItem('x'))->withPadding(0)->setSize(5, 3);
        $pad = Boxer::new($this->strItem('x'))->withPadding(1)->setSize(5, 3);
