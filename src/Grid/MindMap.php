 ...
 */
final class MindMap implements Sizer
{
    ...
    public function __construct(
        ...
        private readonly MindMapDirection $direction = MindMapDirection::LeftRight,
        private readonly ConnectionStyle $connectionStyle = ConnectionStyle::Rounded,
        private readonly ?Color $rootColor = null,
