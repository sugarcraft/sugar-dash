 ...
 */
final class Window implements \SugarCraft\Dash\Foundation\Sizer
{
     ...
     */
    public static function new(\SugarCraft\Dash\Foundation\Item $content, ?string $title = null): self
    {
        return new self(
            content: $content,
            title: $title,
